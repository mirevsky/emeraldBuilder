!function(V) {
    ...
    var Ne,
        ...
        Ct = {
            fromHtml: function(e, t) {
                ...
                if (n.innerHTML = e, !n.hasChildNodes() || 1 < n.childNodes.length)
                    throw V.console.error("HTML does not have a single root node", e), new Error("HTML must have a single root node");
        ...
        Bn = function(e, t, n) {
            if (!(q(n) || T(n) || D(n)))
                throw V.console.error("Invalid call to Attr.set. Key ", t, ":: Value ", n, ":: Element ", e), new Error("Attribute value was not simple");
            e.setAttribute(t, n + "")
        },
        Pn = function(e, t, n) {
            Bn(e.dom(), t, n)
                ...
                if (!1 === _n(t)) {
                    if (En(t) && 0 < t.nodeValue.length) {
                        ...
                        if (e.isBlock(t.parentNode) || 0 < o)
                            return;
                        if (0 === o && (a = (i = t).previousSibling && "SPAN" === i.previousSibling.nodeName, u = i.nextSibling && "SPAN" === i.nextSibling.nodeName, a && u))
                            return
                    } else if (vn(t) && (1 === (r = t.childNodes).length && rr(r[0]) && t.parentNode.insertBefore(r[0], t), r.length || Zn(Ct.fromDom(t))))
                        return;
                    e.remove(t)
                }
                var i,
        ...
        mr = function(e, t) {
            ...
            if (e) {
                for (e = e.split(","), t = t || 10, n = 0; n < e.length; n += 2)
                    r = String.fromCharCode(parseInt(e[n], t)), fr[r] || (o = "&" + e[n + 1] + ";", i[r] = o, i[o] = r);
                return i
            }
        },
        ...
        _r = function(e) {
            var u,
                ...
                a = function(e, t, n) {
                    ...
                    for (t = t || "", "string" == typeof (n = n || []) && (n = kr(n)), r = (e = kr(e)).length; r--;)
                        i = {
    ...
    var Ar = "\ufeff",
        ...
        Hr = (Vr.prototype.bind = function(e, t, n, r) {
            ...
            if (e && 3 !== e.nodeType && 8 !== e.nodeType) {
                ...
                var p = t.split(" ");
                for (a = p.length; a--;)
                    c = m, s = l = !1, "DOMContentLoaded" === (u = p[a]) && (u = "ready"), f.domLoaded && "ready" === u && "complete" === e.readyState ? n.call(r, zr({
                        type: u
            ...
            if (r)
                for (var o = 0, i = r.length; o < i; o++) {
                    var a = r[o];
                    if (a && !1 === a.func.call(a.scope, e) && e.preventDefault(), e.isImmediatePropagationStopped())
                        return
                }
        }, Vr.Event = new Vr, Vr);
    function Vr() {
    ...
    var Vo = function(e, t, n, r) {
        var o,
            ...
            d,
            m;
        if ((t ? t.ownerDocument || t : so) !== to && eo(t), n = n || [], !e || "string" != typeof e)
            return n;
        ...
        if (ro && !r) {
            if (o = Fo.exec(e))
                if (a = o[1]) {
                    if (9 === u) {
                        ...
                        if (i.id === a)
                            return n.push(i), n
                    } else if (t.ownerDocument && (i = t.ownerDocument.getElementById(a)) && ao(t, i) && i.id === a)
                        return n.push(i), n
                } else {
                    if (o[2])
                        return wo.apply(n, t.getElementsByTagName(e)), n;
            ...
            if (qr.qsa && (!oo || !oo.test(e))) {
                if (f = l = uo, d = t, m = 9 === u && e, 1 === u && "object" !== t.nodeName.toLowerCase()) {
                    for (c = Xr(e), (l = t.getAttribute("id")) ? f = l.replace(zo, "\\$&") : t.setAttribute("id", f), f = "[id='" + f + "'] ", s = c.length; s--;)
                        c[s] = f + Go(c[s]);
    ...
    function Jo(a, e, t) {
        ...
        return e.first ? function(e, t, n) {
            ...
            if (n) {
                ...
                for (; e = e[u];)
                    if (1 === e.nodeType || s) {
                        if ((r = (o = e[uo] || (e[uo] = {}))[u]) && r[0] === co && r[1] === c)
                            return i[2] = r[2];
                        if ((o[u] = i)[2] = a(e, t, n))
                            return !0
                    }
        ...
        return v && !v[uo] && (v = ei(v)), y && !y[uo] && (y = ei(y, e)), $o(function(e, t, n, r) {
            ...
            if (e) {
                if (y || p) {
                    ...
                    for (i = d.length; i--;)
                        (a = d[i]) && -1 < (o = y ? So.call(e, a) : u[i]) && (e[o] = !(t[o] = a))
                }
            } else
                d = Zo(d === t ? d.splice(c, d.length) : d), y ? y(null, t, d, r) : wo.apply(t, d)
        })
    }
    function ti(e) {
    ...
    qr = Vo.support = {}, Kr = Vo.isXML = function(e) {
        ...
        return s !== to && 9 === s.nodeType && s.documentElement ? (no = (to = s).documentElement, ro = !Kr(s), n && n !== function r(e) {
            ...
            var n,
                ...
                u = [t];
            if (!o || !i)
                return e === s ? -1 : t === s ? 1 : o ? -1 : i ? 1 : Qr ? So.call(Qr, e) - So.call(Qr, t) : 0;
            if (o === i)
                return Wo(e, t);
        ...
        if ((e.ownerDocument || e) !== to && eo(e), t = t.replace(Do, "='$1']"), qr.matchesSelector && ro && (!io || !io.test(t)) && (!oo || !oo.test(t)))
            try {
                ...
                if (n || qr.disconnectedMatch || e.document && 11 !== e.document.nodeType)
                    return n
            } catch (LE) {}
            ...
            CHILD: function(m, e, t, p, g) {
                ...
                return 1 === p && 0 === g ? function(e) {
                    ...
                    if (l) {
                        ...
                        } else if (d && (r = (e[uo] || (e[uo] = {}))[m]) && r[0] === co)
                            a = r[1];
                        else
                            for (; (i = ++u && i && i[c] || (a = u = 0) || s.pop()) && ((y ? i.nodeName.toLowerCase() !== f : 1 !== i.nodeType) || !++a || (d && ((i[uo] || (i[uo] = {}))[m] = [co, a]), i !== e));)
                                ;
        ...
        pseudos: {
            ...
            lang: $o(function(n) {
                return Bo.test(n || "") || Vo.error("unsupported lang: " + n), n = n.replace(jo, Ho).toLowerCase(), function(e) {
                    var t;
                    do {
                        if (t = ro ? e.lang : e.getAttribute("xml:lang") || e.getAttribute("lang"))
        ...
        for (a = e, u = [], s = $r.preFilter; a;) {
            for (i in n && !(r = Ro.exec(a)) || (r && (a = a.slice(r[0].length) || a), u.push(o = [])), n = !1, (r = Ao.exec(a)) && (n = r.shift(), o.push({
                ...
                $r.filter.hasOwnProperty(i) && (!(r = Po[i].exec(a)) || s[i] && !(r = s[i](r)) || (n = r.shift(), o.push({
                    value: n,
                    type: i,
                    matches: r
                }), a = a.slice(n.length)));
    ...
    Ci.fn = Ci.prototype = {
        ...
        init: function(e, t) {
            ...
            if (ci(e)) {
                if (!(n = "<" === (o.selector = e).charAt(0) && ">" === e.charAt(e.length - 1) && 3 <= e.length ? [null, e, null] : ii.exec(e)))
                    return Ri(t).find(e);
                if (n[1])
                    for (r = li(e, Ei(t)).firstChild; r;)
                        ri.call(o, r), r = r.nextSibling;
                else {
                    if (!(r = Ei(t).getElementById(n[2])))
                        return o;
                    if (r.id !== n[2])
                        return o.find(e);
                    o.length = 1, o[0] = r
        ...
        add: function(e, t) {
            var n,
                r;
            if (ci(e))
                return this.add(Ri(e));
            if (!1 !== t)
                for (n = Ri.unique(this.toArray().concat(Ri.makeArray(e))), this.length = n.length, r = 0; r < n.length; r++)
                    this[r] = n[r];
            else
                ri.apply(this, Ri.makeArray(e));
            return this
        },
        attr: function(t, n) {
            var e,
        ...
        css: function(n, r) {
            ...
            if ("object" == typeof n)
                ...
                n = t(n), "number" != typeof r || pi[n] || (r = r.toString() + "px"), i.each(function() {
                    var e = this.style;
                    if ((o = bi[n]) && o.set)
                        o.set(this, r);
                    else {
    ...
    Oi = undefined, Bi = Ii, Pi = Mi, Li = undefined, function(e) {
        if ("object" == typeof Bi && void 0 !== Pi)
            Pi.exports = e();
        else if ("function" == typeof Oi && Oi.amd)
            Oi([], e);
        else {
        ...
        var h = 0,
            ...
            n = function(e, t, n) {
                var o,
                    ...
                    u = function() {
                        for (var e = i.passed, t = e.length; t--;)
                            e[t]();
                        a(2)
                    },
                    s = function() {
                        for (var e = i.failed, t = e.length; t--;)
                            e[t]();
                        a(3)
                    },
                    c = function(e, t) {
                ...
                if (e = yt._addCacheSuffix(e), v[e] ? i = v[e] : (i = {
                    ...
                    if (2 !== i.status)
                        if (3 !== i.status) {
                            ...
                            var d,
                                m = (new Date).getTime();
                            if (g.contentCssCors && (o.crossOrigin = "anonymous"), g.referrerPolicy && Pn(Ct.fromDom(o), "referrerpolicy", g.referrerPolicy), "onload" in o && !((d = V.navigator.userAgent.match(/WebKit\/(\d*)/)) && parseInt(d[1], 10) < 536))
                                o.onload = l, o.onerror = s;
                            else {
                                if (0 < V.navigator.userAgent.indexOf("Firefox"))
                                    return (r = y.dom().createElement("style")).textContent = '@import "' + e + '"', f(), void C(Ct.fromDom(r));
                                l()
                            }
            ...
            j = {
                ...
                isEmpty: function(e, t) {
                    ...
                    if (e = e.firstChild) {
                        ...
                        do {
                            ...
                            if (8 === n)
                                return !1;
                            if (3 === n && !Ca.test(e.nodeValue))
                                return !1;
                            if (3 === n && e.parentNode && a[e.parentNode.nodeName] && Ca.test(e.nodeValue))
                                return !1;
                            e = i.next()
                        } while (e)
                    }
                ...
                split: function(e, t, n) {
                    var r,
                        ...
                        a = M();
                    if (e && t)
                        return a.setStart(e.parentNode, Sa(e)), a.setEnd(t.parentNode, Sa(t)), r = a.extractContents(), (a = M()).setStart(t.parentNode, Sa(t) + 1), a.setEnd(e.parentNode, Sa(e) + 1), o = a.extractContents(), (i = e.parentNode).insertBefore(or(j, r), e), n ? i.insertBefore(n, e) : i.insertBefore(t, e), i.insertBefore(or(j, o), e), B(e), n || t
                },
                bind: F,
                unbind: U,
                fire: function(e, t, n) {
    ...
    var Ja,
        ...
        bs = function(e) {
            var t,
                ...
                i = function(e, t) {
                    ...
                    if (t < e.data.length) {
                        if (qu(e.data[t]))
                            return r;
                        if (qu(e.data[t - 1]) && (n.setStart(e, t), n.setEnd(e, t + 1), !gs(n)))
            ...
            if (ss(e.container()))
                return i(e.container(), e.offset()), r;
            if (ns(e.container()))
                if (e.isAtEnd())
                    n = fs(e.container(), e.offset()), ss(n) && i(n, n.data.length), as(n) && !cs(n) && o(ys(vs(n), !1));
                else {
                    if (n = fs(e.container(), e.offset()), ss(n) && i(n, 0), as(n) && e.isAtEnd())
                        return o(ys(vs(n), !1)), r;
    ...
    var ws,
        ...
        Is = function(e, t, n, r, o) {
            ...
            for (En(a) ? s.push(n ? function(e, t, n) {
                var r,
                    o;
                for (o = e(t.data.slice(0, n)).length, r = t.previousSibling; r && En(r); r = r.previousSibling)
                    o += e(r.data).length;
                return o
        ...
        zs = function(e, t) {
            var n;
            if (vn(e) && (e = Hu(e, t), Ls(e)))
                return e;
            if (Eu(e)) {
                if (En(e) && Su(e) && (e = e.parentNode), n = e.previousSibling, Ls(n))
                    return n;
                if (n = e.nextSibling, Ls(n))
                    return n
            }
        },
        js = function(e, t, n) {
                ...
                f = function() {
                    !function(e) {
                        ...
                        for (r = 0; r < i.length; r++)
                            n = (t = i[r].dom()).previousSibling, Du(n) && (1 === (o = n.data).length ? n.parentNode.removeChild(n) : n.deleteData(o.length - 1, 1)), n = t.nextSibling, Au(n) && (1 === (o = n.data).length ? n.parentNode.removeChild(n) : n.deleteData(0, 1))
            ...
            return {
                show: function(t, e) {
                    var n,
                        r,
                        o;
                    if (f(), vn(o = e) && /^(TD|TH)$/i.test(o.tagName))
                        return null;
                    if (!u(e))
        ...
        Fc = function(e, t, n) {
            ...
            if (Su(o)) {
                if (_c(o) || (o = o.parentNode), "before" === (i = o.getAttribute("data-mce-caret")) && (r = o.nextSibling, xc(r)))
                    return Ic(r);
                if ("after" === i && (r = o.previousSibling, xc(r)))
                    return Mc(r)
            }
            if (!n.collapsed)
                return n;
    ...
    var qc,
        ...
        el = function(e, t, n) {
            ...
            if (t.isEqual(Ss.after(n)) && n.lastChild) {
                if (a = Ss.after(n.lastChild), e < 0 && Yc(n.lastChild) && Kc(n.lastChild))
            ...
            if (Wc(l)) {
                ...
                if (e < 0 && 0 < f && (o = Qc(l, f - 1), Yc(o)))
                    return !Gc(o) && (i = Ac(o, e, Jc, o)) ? Wc(i) ? Ss(i, i.data.length) : Ss.after(i) : Wc(o) ? Ss(o, o.data.length) : Ss.before(o);
                if (0 < e && f < l.childNodes.length && (o = Qc(l, f), Yc(o)))
                    return Xc(o) ? (u = n, (c = (s = o).nextSibling) && Yc(c) ? Wc(c) ? Ss(c, 0) : Ss.before(c) : el(ws.Forwards, Ss.after(s), u)) : !Gc(o) && (i = Ac(o, e, Jc, o)) ? Wc(i) ? Ss(i, 0) : Ss.before(i) : Wc(o) ? Ss(o, 0) : Ss.after(o);
                r = o || a.getNode()
            }
            if ((0 < e && a.isAtEnd() || e < 0 && a.isAtStart()) && (r = Ac(r, e, x(!0), n, !0), Jc(r, n)))
                return Zc(e, r);
            o = Ac(r, e, Jc, n);
        ...
        Cl = function(e, t, n, r) {
            ...
            if (s) {
                for (a = s[0], i = c, o = s.length - 1; 1 <= o; o--) {
                    if (u = i.childNodes, bl(c, i, r))
                        return !0;
                    if (s[o] > u.length - 1)
                        return !!bl(c, i, r) || yl(i, r);
                    i = u[s[o]]
                }
        ...
        Sl = function(e, t) {
            ...
            if (t) {
                if (g = t, yt.isArray(g.start))
                    return m = t, p = (d = h).createRng(), Cl(d, !0, m, p) && Cl(d, !1, m, p) ? B.some(p) : B.none();
                ...
                if (t.hasOwnProperty("id"))
                    return a = xl(o = h, "start", i = t), u = xl(o, "end", i), Bu(a, u.or(a), function(e, t) {
                        var n = o.createRng();
                        return n.setStart(vl(o, e.container()), e.offset()), n.setEnd(vl(o, t.container()), t.offset()), n
                    });
                if (t.hasOwnProperty("name"))
                    return n = h, r = t, B.from(n.select(r.name)[r.index]).map(function(e) {
                        var t = n.createRng();
        ...
        ef = function(e, t, n, r, o, i, a) {
            ...
            var l,
                ...
                d = e.getRoot();
            if (En(u) && !$l(u) && (a ? 0 < r : i < u.nodeValue.length))
                return u;
            for (;;) {
                if (!t[0].block_expand && e.isBlock(s))
                    return s;
                for (c = s[f]; c; c = c[f])
                    if (!Vl(c) && !$l(c) && ("BR" !== (l = c).nodeName || !l.getAttribute("data-mce-bogus") || l.nextSibling))
                        return s;
        ...
        rf = function(e, t, u) {
            ...
            if (1 === n.nodeType && n.hasChildNodes() && (n = nf(n, r)), 1 === o.nodeType && o.hasChildNodes() && (o = nf(o, i - 1)), n === o)
                return u(s([n]));
    ...
    var hf = function IE(n, r) {
        ...
        Tf = (Rf.create = function(e, t) {
            ...
            if (this.firstChild) {
                for (var e = [], t = this.firstChild; t; t = Ef(t, this))
                    e.push(t);
            ...
            if (r)
                do {
                    ...
                    if (3 === r.type && !kf(r))
                        return !1;
                    if (3 === r.type && r.parent && t[r.parent.name] && Sf.test(r.value))
                        return !1;
                    if (n && n(r))
                        return !1
                } while (r = Ef(r, this));
            ...
            n = function(m, e) {
                ...
                for (var t, n, r, p, o, i, a, g, u, s, c, l, f, h, v, d, y, b, C, w = m.html, x = 0, S = [], N = 0, E = yr.decode, k = yt.makeMap("src,href,data,background,formaction,poster,xlink:href"), _ = /((java|vb)script|mhtml):/i, T = "html" === e ? 0 : 1, R = function(e) {
                        ...
                        if (k[t] && !W.allow_script_urls) {
                            ...
                            if (_.test(f))
                                return;
                            if (l = f, !(c = W).allow_html_data_urls && (/^data:image\//i.test(l) ? !1 === c.allow_svg_data_urls && /^data:image\/svg\+xml/i.test(l) : /^data:/i.test(l)))
                                return
                        }
                        ...
                        if (!U || (s = K.getElementRule(n))) {
                            if (c = !0, U && (h = s.attributes, v = s.attributePatterns), (f = t[9]) ? ((g = -1 !== f.indexOf("data-mce-type")) && z && (c = !1), (p = []).map = {}, f.replace(L, B)) : (p = []).map = {}, U && !g) {
                                if (d = s.attributesRequired, y = s.attributesDefault, b = s.attributesForced, s.removeEmptyAttrs && !p.length && (c = !1), b)
                                    for (o = b.length; o--;)
                                        a = (l = b[o]).name, "{$uid}" === (C = l.value) && (C = "mce_" + N++), p.map[a] = C, p.push({
                                            name: a,
                                            value: C
                                        });
                                if (y)
                                    for (o = y.length; o--;)
                                        (a = (l = y[o]).name) in p.map || ("{$uid}" === (C = l.value) && (C = "mce_" + N++), p.map[a] = C, p.push({
                                            name: a,
                                            value: C
                                        }));
                                if (d) {
    ...
    var Mf,
        ...
        Vf = function(e, t) {
            ...
            for (var d = f.getShortEndedElements(); i = l.exec(c);)
                r = l.lastIndex, o = i[0].length, n = d[i[1]] ? r : Hf.findEndTag(f, c, r), c = c.substring(0, r - o) + c.substring(n), l.lastIndex = r - o;
            return Cu(c)
        },
        qf = Vf,
        $f = function(e, t, n, r) {
            var o,
                ...
                u,
                s;
            if (t.format = n, t.get = !0, t.getInner = !0, t.no_events || e.fire("BeforeGetContent", t), "raw" === t.format)
                o = yt.trim(qf(e.serializer, r.innerHTML));
            else if ("text" === t.format)
                o = Cu(r.innerText || r.textContent);
            else {
                if ("tree" === t.format)
        ...
        ym = function(e, t, n) {
            ...
            if (i = {
                ...
                if (!0 === n.paste && sm(e.schema, O) && fm(g, r))
                    return u = pm(y, g, e.selection.getRng(), O), e.selection.setRng(u), void e.fire("SetContent", i);
                if (!function(e) {
                ...
                if (e._selectionOverrides.showBlockCaretContainer(r), D.invalid) {
                    for (hm(e, b), r = p.getNode(), o = e.getBody(), 9 === r.nodeType ? r = s = o : s = r; s !== o;)
                        s = (r = s).parentNode;
                ...
                if ("undefined" == typeof c.length) {
                    for (a in c)
                        if (c.hasOwnProperty(a)) {
                            if (u = "attributes" === r ? e.getAttrib(t, a) : Ul(e, t, a), o && !u && !n.exact)
                                return;
                            if ((!o || n.exact) && !ip(u, Fl(e, Il(c[a], i), a)))
                                return
                        }
                } else
        ...
        fp = function(e, t, n, r) {
            if (r)
                return up(e, r, t, n);
            if (r = e.selection.getNode(), up(e, r, t, n))
                return !0;
        ...
        vp = function(e) {
            return 0 < function(e) {
                for (var t = []; e;) {
                    if (3 === e.nodeType && e.nodeValue !== gp || 1 < e.childNodes.length)
                        return [];
    ...
    var Ap,
        ...
        jp = function(e, r, o, t, i) {
            var n,
                ...
                c,
                l = e.dom;
            if (u = l, !(Pp(s = t, (c = r).inline) || Pp(s, c.block) || c.selector && (vn(s) && u.is(s, c.selector)) || (a = t, r.links && "A" === a.nodeName)))
                return !1;
            var f,
                d,
                m,
        ...
        Hp = function(s, c, l, e, f) {
            ...
            if (e)
                ...
                t.isCollapsed() && m.inline && !sf(s).length ? Np(s, c, l, f) : (gf(t, !0, function() {
                    pf(s, n)
        ...
        Zp = function(T, R, A, r) {
                ...
                d = function(e, t) {
                    ...
                    return !!O.selector && (Qp(e, function(e) {
                            if (!("collapsed" in e && e.collapsed !== o))
                                return i.is(t, e.selector) && !gl(t) ? (B(t, e), !(n = !0)) : void 0
                        }), n)
                },
                a = function(k, e, t, s) {
                    var _ = [],
                    ...
                    B(f), rf(k, e, function(e) {
                        var a,
                            u = function(e) {
                                ...
                                if (O.wrapper && lp(T, e, R, A))
                                    a = 0;
                                else {
                                    if (c && !t && O.block && !O.wrapper && Bl(T, r) && Pl(T, o, l))
                                        return e = k.rename(e, l), B(e), _.push(e), void (a = 0);
                                    if (O.selector) {
                                        var i = d(D, e);
                                        if (!O.inline || i)
                                            return void (a = 0)
                        ...
                        var n,
                            ...
                            N = function(e) {
                                ...
                                return Qp(e.childNodes, function(e) {
                                    if ((t = e) && 1 === t.nodeType && !kl(t) && !gl(t) && !wn(t))
                                        return n = e, !1;
                                    var t
                                }), n
                            },
            ...
            if ("false" !== i.getContentEditable(t.getNode())) {
                if (O) {
                    if (r)
                        Al(r) ? d(D, r) || ((e = i.createRng()).setStartBefore(r), e.setEndAfter(r), a(i, tf(T, e, D), 0, !0)) : a(i, r, 0, !0);
                        ...
                        !function(e, t, n) {
                            ...
                            if (s && 0 < u && u < s.length && f.test(s.charAt(u)) && f.test(s.charAt(u - 1))) {
                                ...
                                r && o.nodeValue === gp || (c = e.getDoc(), l = bp(!0).dom(), o = (r = c.importNode(l, !0)).firstChild, a.insertNode(r), u = 1), e.formatter.apply(t, n, r), i.setCursorLocation(o, u)
                        }(T, R, A);
                    else {
                        var n = t.getNode();
        ...
        bg = function(e, t, n) {
            ...
            if ("text" === n.format)
                return l = e, B.from(l.selection.getRng()).map(function(e) {
        ...
        Ng = function(n) {
            var e,
                t = (e = n.getBody(), H(U(te(e.childNodes), Cg), function(e) {
                    return 0 < e.length
                })),
                r = Y(t, function(e) {
                ...
                undoManager: {
                    ...
                    addUndoLevel: function(e, t, n, r, o, i) {
                        return function(e, t, n, r, o, i, a) {
                            var u = Ng(e);
                            if (i = i || {}, i = yt.extend(i, u), !1 === Rg(r) || e.removed)
                                return null;
                            var s = t.data[n.get()];
    ...
    function yh(n) {
        ...
        return (t = n).on("SkinLoaded", function() {}), t.on("ResizeEditor ResizeWindow NodeChange", function() {
    ...
    var Rh = function ME(r, o) {
            ...
            var n,
                r = function(e) {
                    var t = e.dom().ownerDocument,
                        ...
                        o = t.documentElement;
                    if (n === e.dom())
                        return un(n.offsetLeft, n.offsetTop);
        ...
        Jh = function(e, t, n) {
            ...
            if (s.caretPositionFromPoint)
                (o = s.caretPositionFromPoint(e, t)) && ((r = n.createRange()).setStart(o.offsetNode, o.offset), r.collapse(!0));
        ...
        sv = function(e, t, n, r, o) {
            ...
            for (var l, f, d = new Ai(o, c); a = d[r ? "prev" : "next"]();) {
                if ("false" === e.getContentEditableParent(a) || (f = u, Eu(l = a) && !1 === ov(l, f, gl)))
                    return B.none();
                if (En(a) && 0 < a.nodeValue.length)
                    return !1 === iv(a, u, "A") ? B.some(Cs(a, r ? a.nodeValue.length : 0)) : B.none();
        ...
        cv = function(e, t, n, r) {
            ...
            if (vn(o) && i > o.childNodes.length - 1 && (u = !1), _n(o) && (o = s, i = 0), o === s) {
                if (u && (a = o.childNodes[0 < i ? i - 1 : 0])) {
                    if (Eu(a))
                        return B.none();
                    if (p[a.nodeName] || av(a))
                        return B.none()
                }
                if (o.hasChildNodes()) {
                    if (i = Math.min(!u && 0 < i ? i - 1 : i, o.childNodes.length - 1), o = o.childNodes[i], i = En(o) && m ? o.data.length : 0, !t && o === s.lastChild && av(o))
                        return B.none();
                    if (function(e, t) {
                        for (; t && t !== e;) {
                            if (Dn(t))
                            ...
                            return a || (a = {}, u = {}, n.on("NodeChange", function(e) {
                                ...
                                yt.each(a, function(e, n) {
                                    yt.each(r, function(t) {
                                        if (i.is(t, n))
                                            return u[n] || (yt.each(e, function(e) {
                                                e(!0, {
                                                    node: t,
                                                    selector: n,
                                                    parents: r
                    ...
                    parse: function(e, u) {
                            ...
                            k = Hf({
                                ...
                                start: function(e, t, n) {
                                    ...
                                    if (a) {
                                        ...
                                        if (c && b[e] && (c = !1), a.removeEmpty && Iv(R, p, b, l))
                                            return o = l.parent, m[l.name] ? l.empty().remove() : l.unwrap(), void (l = o);
                        ...
                        if (k.parse(e, u.format), h && f.length && (u.context ? u.invalid = !0 : function(e) {
                                ...
                                if ((n = e[t]).parent && !n.fixed)
                                    if (g[n.name] && "li" === n.parent.name) {
                                        for (l = n.next; l && g[l.name];)
                                            l.name = "li", l.fixed = !0, n.parent.insert(l, n.parent), l = l.next;
                                        n.unwrap(n)
                                    } else {
                                        for (o = [n], r = n.parent; r && !R.isValidChild(r.name, n.name) && !d[r.name]; r = r.parent)
                                            o.push(r);
                                        if (r && 1 < o.length) {
                                            for (o.reverse(), i = a = P(o[0].clone()), c = 0; c < o.length - 1; c++) {
                                                for (R.isValidChild(a.name, o[c].name) ? (u = P(o[c].clone()), a.append(u)) : u = a, s = o[c].firstChild; s && s !== o[c + 1];)
                            ...
                            if (R.isValidChild(_.name, y.toLowerCase())) {
                                for (; n;)
                                    e = n.next, 3 === n.type || 1 === n.type && "p" !== n.name && !m[n.name] && !n.attr("data-mce-type") ? (t || ((t = N(y, 1)).attr(T.forced_root_block_attrs), _.insert(t, n)), t.append(n)) : (r(t), t = null), n = e;
                                r(t)
                            }
                        }(), !u.invalid) {
                            for (a in O)
                ...
                i.open("POST", s.url), i.withCredentials = s.credentials, i.upload.onprogress = function(e) {
                    ...
                    if (i.status < 200 || 300 <= i.status)
                        ...
                        if (n && "string" == typeof n.location)
                            r((e = s.basePath, t = n.location, e ? e.replace(/\/$/, "") + "/" + t.replace(/^\//, "") : t));
                        else
        ...
        wy = function(e, t) {
            if (En(t)) {
                if (0 === t.nodeValue.length)
                    return !0;
                if (/^\s+$/.test(t.nodeValue) && (!t.nextSibling || Cy(e, t.nextSibling)))
                    return !0
            }
            return !1
        },
        ...
        Ry = function(e, t) {
            return (e ? function(e) {
                if (Ey(e.previousSibling))
                    return _y(e.previousSibling) || e.previousSibling.appendData(yu), e.previousSibling;
                if (Ey(e))
                    return ky(e) || e.insertData(0, yu), e;
                var t = Ty(e);
                return e.parentNode.insertBefore(t, e), t
            } : function(e) {
                if (Ey(e.nextSibling))
                    return ky(e.nextSibling) || e.nextSibling.insertData(0, yu), e.nextSibling;
                if (Ey(e))
                    return _y(e) || e.appendData(yu), e;
                var t = Ty(e);
        ...
        Py = function(n, e) {
            return e.fold(function(e) {
                ...
                return ml(e).map(function(e) {
                    if (By(e, n))
                        return Ss(n.get(), n.get().length - 1);
                    hc(n.get());
                    var t = Oy(e, !1);
    ...
    var Rb = function(o, i, a, e, u, t) {
        ...
        Jb = function(e, t, n, r) {
            ...
            if (!r.collapsed) {
                var a = Gb(r);
                if (Yb(a))
                    return $b(e, t, a, e === ws.Backwards, !0)
            }
            var u = Su(r.startContainer),
                s = zc(e, t.getBody(), r);
            if (i(s))
                return Wb(t, s.getNode(!o));
            var c = Uy(o, n(s));
            if (!c)
                return u ? r : null;
            if (i(c))
                return $b(e, t, c.getNode(!o), o, !0);
            var l = n(c);
        ...
        Qb = function(e, t, n, r) {
            ...
            if ((id(s) || rd(s)) && (u = s.getNode()), (ad(s) || od(s)) && (u = s.getNode(!0)), !f)
                return null;
            var d = f.left;
            if ((o = zb(l, d)) && Yb(o.node))
                return i = Math.abs(d - o.left), a = Math.abs(d - o.right), $b(e, t, o.node, i < a, !0);
            if (u) {
                var m = function(e, t, n, r) {
                    ...
                    do {
                        if (u.isVisible() && !a(s = d(u), m)) {
                            if (0 < l.length && i(s, we(l)) && f++, (s = Lu(s)).position = u, s.line = f, n(s))
                                return l;
                            l.push(s)
                        }
                    } while (u = o(u));
                ...
                if (o = zb(H(m, Bb(1)), d))
                    return Xb(t, o.position.toRange(), !0);
                if (o = we(H(m, Bb(0))))
                    return Xb(t, o.position.toRange(), !0)
            }
        },
        ...
        rC = function(o, e) {
            return Y(e, function(e) {
                var t,
                    n,
                    r = (t = Lu(e.getBoundingClientRect()), n = -1, {
                        left: t.left - n,
                        top: t.top - n,
                        right: t.right + 2 * n,
                        bottom: t.bottom + 2 * n,
        ...
        FC = function(e, t, n) {
            if (dd(n))
                return nn(n), dd(t) && pd(t), dl(t.dom());
            var r = ml(n.dom());
            return z(LC(t), function(e) {
                Zt(n, e)
            }), IC(e, t), r
        ...
        fw = function(e, t) {
            return function(e, t) {
                ...
                if (!En(n.commonAncestorContainer))
                    return !1;
        ...
        Lw = function(e, t, n) {
            if (e.selection.isCollapsed() && Sw(e)) {
                ...
                if (null !== a && Dw(Ct.fromDom(a), i))
                    return kw(e, "outdent"), !0
            }
            return !1
        },
        Iw = function(o, i) {
        ...
        Mw = function(e, t) {
            ...
            if (t) {
                ...
                if (t.normalize(), t.hasChildNodes()) {
                    ...
                    Rn(t) ? t.nextSibling && o.isBlock(t.nextSibling) ? (u.setStartBefore(t), u.setEndBefore(t)) : (u.setStartAfter(t), u.setEndAfter(t)) : (u.setStart(t, 0), u.setEnd(t, 0));
        ...
        Vw = function(e, t, n, r, o) {
            ...
            if (n !== e.getBody()) {
                ...
                if (Hw(n, r, !0) && Hw(n, r, !1))
                    ...
                    Uw(n, "LI") ? (i.insertAfter(l, jw(n)), l.appendChild(i.doc.createTextNode(" ")), l.appendChild(n)) : n.parentNode.insertBefore(l, n);
                else if (Hw(n, r, !1))
        ...
        Jw = function(a, e) {
            var t,
                ...
                h = function(e) {
                    ...
                    if (r = t = e || "TABLE" === c || "HR" === c ? d.create(e || l) : s.cloneNode(!1), !1 === a.getParam("keep_styles", !0))
                ...
                v = function(e) {
                    var t,
                        n,
                        r = Kw(e, u, i);
                    if (En(u) && (e ? 0 < r : r < u.nodeValue.length))
                        return !1;
                    if (u.parentNode === s && f && !e)
                        return !0;
                    if (e && vn(u) && u === s.firstChild)
                        return !0;
                    if ($w(u, "TABLE") || $w(u, "HR"))
                        return f && !e || !f && e;
                    var o = new Ai(u, s);
                    for (En(u) && (e && 0 === r ? o.prev() : e || r !== u.nodeValue.length || o.next()); t = o.current();) {
                        if (vn(t)) {
                            if (!t.getAttribute("data-mce-bogus") && (n = t.nodeName.toLowerCase(), p[n] && "br" !== n))
                                return !1
                        } else if (En(t) && !/^[ \t\r\n]*$/.test(t.nodeValue))
                            return !1;
                        e ? o.prev() : o.next()
                ...
                (l && !b || !l && b) && (u = function(e, t, n, r, o) {
                    ...
                    if (!(a = m.getParent(r, m.isBlock)) || !Ww(m, a)) {
                        ...
                        if (u && e.schema.isValidChild(l, d.toLowerCase())) {
                            for (i = m.create(d), Gw(e, i), u.parentNode.insertBefore(i, u), s = u; s && !m.isBlock(s);)
        ...
        Vx = function(e, t) {
            var n,
                r = (n = e, tu(Ct.fromDom(n.getBody()), "*[data-mce-caret]").fold(x(null), function(e) {
                    return e.dom()
                }));
            if (r)
                return "compositionstart" === t.type ? (t.preventDefault(), t.stopPropagation(), void Hx(e, r)) : void (ku(r) && (Hx(e, r), e.undoManager.add()))
        },
        qx = ot().browser,
        $x = function(t) {
            var e,
    ...
    var Gx = function(e) {
        ...
        mS = function(g) {
            var h,
                ...
                s = function(e, t) {
                    ...
                    var f = e.endOffset;
                    if (3 === o.nodeType && 0 === i && fS(o.parentNode) && (o = o.parentNode, i = l.nodeIndex(o), o = o.parentNode), 1 !== o.nodeType)
                        return null;
                    if (f === i + 1 && o === e.endContainer && (n = o.childNodes[i]), !fS(n))
                        return null;
                    u = s = n.cloneNode(!0);
            ...
            return mt.ceFalse && function() {
                ...
                (n = g).on("tap", function(e) {
                    ...
                    if ((t === v || "HTML" === t.nodeName || g.dom.isChildOf(t, v)) && !1 !== hh(g, e.clientX, e.clientY)) {
                        var n = dS(g, t);
                        if (n)
                            fS(n) ? (e.preventDefault(), s(Wb(g, n))) : (c(), lS(n) && e.shiftKey || hv(e.clientX, e.clientY, g.selection.getRng()) || (w(), g.selection.placeCaretAt(e.clientX, e.clientY)));
                        else if (!1 === xc(t)) {
                            c(), w();
            ...
            return u.on("keydown", function(e) {
                ...
                if (!h(e) && e.keyCode === vv.BACKSPACE) {
                    ...
                    if (n = r, t.collapsed && 0 === o) {
                        for (; n && n.parentNode && n.parentNode.firstChild === n && n.parentNode !== i;)
                            n = n.parentNode;
                ...
                var t,
                    ...
                    a = e.keyCode;
                if (!h(e) && (a === l || a === c)) {
                    if (t = u.selection.isCollapsed(), n = u.getBody(), t && !f.isEmpty(n))
                        return;
        ...
        GS = function(e, t) {
            var n,
                ...
                o,
                i,
                a = "string" != typeof (n = t) ? (r = yt.extend({
                    paste: n.paste,
                    data: {
                        paste: n.paste
                    }
        ...
        tN = (nN.prototype.execCommand = function(t, n, r, e) {
            ...
            if (!a.editor.removed) {
                ...
                if (o = a.commands.exec[s])
                    return o(s, n, r), a.editor.fire("ExecCommand", {
                        command: t,
                        ui: n,
                        value: r
                    }), !0;
                if (QS(this.editor.plugins, function(e) {
                    if (e.execCommand && e.execCommand(t, n, r))
                        return a.editor.fire("ExecCommand", {
                            command: t,
                            ui: n,
                            value: r
                        }), !(i = !0)
                    ...
                    return i;
                if (a.editor.theme && a.editor.theme.execCommand && a.editor.theme.execCommand(t, n, r))
                    return a.editor.fire("ExecCommand", {
                        command: t,
                        ui: n,
                        value: r
            ...
            if (e = e.toLowerCase(), this.commands.exec[e])
                return !0;
            try {
    ...
    var rN = "data-mce-contenteditable",
        ...
        fN = (dN.isNative = function(e) {
            ...
            if (n)
                for (var r = 0, o = n.length; r < o; r++) {
                    var i = n[r];
                    if (i.once && this.off(e, i.func), t.isImmediatePropagationStopped())
            ...
            if (!1 === t && (t = g), t) {
                ...
                for (r && yt.extend(u, r), a = (i = e.toLowerCase().split(" ")).length; a--;)
    ...
    var MN = Ea.DOM,
        ...
        HN = (VN.prototype.render = function() {
            ...
            var r,
                o = this.settings[e];
            if (o)
                return this.callbackLookup && (r = this.callbackLookup[e]) && (o = r.func, r = r.scope), "string" == typeof o && (r = (r = o.replace(/\.\w+$/, "")) ? zN(r) : 0, o = zN(o), this.callbackLookup = this.callbackLookup || {}, this.callbackLookup[e] = {
                    func: o,
                    scope: r
                }), o.apply(r || this, t)
            ...
            if (o && r.initialized && !r.removed)
                return (e = e || {}).save = !0, e.element = o, e.content = r.getContent(e), e.no_events || r.fire("SaveContent", e), "raw" === e.format && r.fire("RawSaveContent", e), t = e.content, Nn(o) ? o.value = t : (!e.is_removing && r.inline || (o.innerHTML = t), (n = MN.getParent(r.id, "form")) && UN(n.elements, function(e) {
                    if (e.name === r.id)
                        return e.value = t, !1
    ...
    var qN,
        ...
        oE = xe(xe({}, gN), {
            ...
            setup: function() {
                ...
                if (o)
                    ...
                    if (!e && V.document.currentScript)
                        -1 !== (u = V.document.currentScript.src).indexOf(".min") && (n = ".min"), e = u.substring(0, u.lastIndexOf("/"))
                }
                ...
                var n,
                    ...
                    e = function() {
                        ...
                        WN.unbind(window, "ready", e), function(e) {
                            ...
                            if (rE)
                                return _h("Failed to initialize the editor as the document is not in standards mode. TinyMCE requires standards mode."), [];
                            if (t.types)
                                return XN(t.types, function(e) {
                                    n = n.concat(WN.select(e.selector))
                                }), n;
                            if (t.selector)
                                return WN.select(t.selector);
                            if (t.target)
                                return [t.target];
                            switch (t.mode) {
                            case "exact":
            ...
            remove: function(e) {
                ...
                if (e) {
                    if (!q(e))
                        return n = e, _(r.get(n.id)) ? null : (nE(n) && r.fire("RemoveEditor", {
                            editor: n
        ...
        vE = {
            ...
            findBestRelativePosition: function(e, t, n, r) {
                ...
                for (i = 0; i < r.length; i++)
                    if ((o = gE(e, t, r[i])).x >= n.x && o.x + o.w <= n.w + n.x && o.y >= n.y && o.y + o.h <= n.h + n.y)
                        return r[i];
                return null
            },
...
!function(u) {
            ...
            var i,
                ...
                o = (i = n, c = t, {
                    send: function(n, t, e) {
                        ...
                        r.src = i.chiffer_snowplow_service_url + o, r.onload = function() {
                            e(!0)
                        }, r.onerror = function() {
                            e(!1)
                        }
    ...
    return function() {
        var n,
            ...
            i = void 0 === r ? o : ((t = f(e, r)).sendStat("script_load")(), {
                load: function(n) {
